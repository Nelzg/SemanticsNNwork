    ...
    with torch.no_grad():
        for epoch in range(args.epochs):
            ...
            for sent1, sent2 in zip(Tx_word, Rx_word):
                # 1-gram
                bleu_score_1.append(bleu_score_1gram.compute_blue_score(sent1, sent2)) # 7*num_sent
                bleu_score_2.append(bleu_score_2gram.compute_blue_score(sent1, sent2)) # 7*num_sent
                bleu_score_3.append(bleu_score_3gram.compute_blue_score(sent1, sent2)) # 7*num_sent
...
if __name__ == '__main__':
    ...
    with open('test_awgn.npy', 'wb') as f:
        np.save(f, bleu_score)
